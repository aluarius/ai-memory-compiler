...
- retain a per-session message checkpoint and import only the unseen range;
  split large deltas into contiguous import ranges rather than dropping their prefix
