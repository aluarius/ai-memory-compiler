...
- **flush.py** calls the Claude Agent SDK to decide what's worth saving, with retry logic for transient failures. After 10 PM triggers end-of-day compilation automatically
